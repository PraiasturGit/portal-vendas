        ...
        <div className="px-4 pb-2">
          <div className="relative">
            ...
            <input
              ...
              className="h-11 w-full rounded-2xl border border-gray-200 bg-[#f8fafc] pl-10 pr-4 text-sm text-[#111827] outline-none focus:border-green-500 focus:ring-4 focus:ring-green-100"
            />
          </div>
        </div>
...
export default function ConvitePage() {
  ...
  const validateForm = () => {
    const newErrors: ErrorState = {
      ...
      evento: !validateField("evento", form.evento),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post("/api/convites", payload);
        ...
        <div className="sticky top-0 z-10 mb-3 bg-white px-3 py-3 shadow-sm">
          <div className="mx-auto flex max-w-md items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-green-700">
              <Ticket size={20} />
              <h1 className="text-lg font-bold text-gray-800">Novo Convite</h1>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-2.5 px-3 pb-3">
                ...
                <div className="pt-1">
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-green-600 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-70"
                  >
                    <Send size={16} className="shrink-0" />
                    <span className="leading-none">ENVIAR CONVITE</span>
                  </button>
                </div>
              </div>
            </Card>
